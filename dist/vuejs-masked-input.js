...
(function (global, factory) {
  ...
  var MaskedInput = {
    ...
    props: {
      ...
      mask: {
        required: true,
        validator: function (value) { return !!((value && value.length >= 1) || value instanceof Object); },
      },
      placeholderChar: {
        type: String,
        default: '_',
        validator: function (value) { return !!(value && value.length === 1); },
      },
      disabled: {
        type: Boolean,
        default: false,
    ...
    methods: {
        ...
        try {
          if (this.mask instanceof Object) {
            ...
            this.maskCore = new lib({
              ...
              formatCharacters: {
                'a': {
                  validate: function (char) { return /^[A-Za-zА-Яа-я]$/.test(char); },
                },
                'A': {
                  validate: function (char) { return /^[A-Za-zА-Яа-я]$/.test(char); },
                  transform: function (char) { return char.toUpperCase(); },
                ...
                '*': {
                  validate: function (char) { return /^[\dA-Za-zА-Яа-я]$/.test(char); },
                },
                '#': {
                  validate: function (char) { return /^[\dA-Za-zА-Яа-я]$/.test(char); },
                  transform: function (char) { return char.toUpperCase(); },
          ...
          [].concat( this.$refs.input.value ).reduce(function (memo, item) { return this$1.maskCore.input(item); }, null);
      ...
      keyDown: function keyDown(e) { // Always
      ...
      keyPress: function keyPress(e) { // works only on Desktop
      ...
      paste: function paste(e) {
        ...
        [].concat( text ).reduce(function (memo, item) { return this$1.maskCore.input(item); }, null);
        this.updateToCoreState();
      },
